...
| **A/B Testing - solid base**|[link](https://github.com/Abhudeep/Abhu-s-Guides/blob/main/Analyze_ab_test_results_notebook.ipynb)| Basics of A/B testing, examples and learning: <ul><li> Step 1: Calculate sample size, decide practical significance /mde </li><li>Step 2: Choose and characterize metrics for both **sanity check and evaluation** </li><li>Step 3: Designing an experiment </li><li>Step 4: Analyzing Results </li><li>Simple Sequential A/B Testing </li><li>Comparing Classic and Sequential A/B Tests </li><li> |
