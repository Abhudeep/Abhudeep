...
| **Regression Analysis: An Intuitive Guide for Using and Interpreting Linear Models** Jim Frost| [link](https://www.amazon.com/Regression-Analysis-Intuitive-Interpreting-Linear/dp/1735431184)|
...
| **Regression**| [link](https://github.com/Abhudeep/Abhu-s-Guides/blob/main/01-Linear%20Regression%20with%20Python.ipynb)|Conversion of Regression Analysis: An Intuitive Guide for Using and Interpreting Linear Models by Jim Frost from Minitab to Python notebook|
| **Classification** |[link](https://github.com/Abhudeep/Abhu-s-Guides/blob/main/Classification.ipynb)| Assumptions, sigmoid function, decision boundary, gradient descent and implementation|
...
|---|---|---|
| 🆔 [Udiddit, A Social News Aggregator](https://github.com/Abhudeep/Udiddit-a-social-news-aggregator/tree/main) | Part I: Investigate the existing schema, Part II: Create the DDL for your new schema, Part III: Migrate the provided data| Advanced SQL |  
...
| 📲 [311-Request-Analysis](https://github.com/Abhudeep/311-Request-Analysis/blob/main/data%20analysis.ipynb) | Data Wrangling & EDA | Project involved data analysis of service request (311) calls from New York City utilizing data wrangling techniques to understand the pattern in the data and visualize the major types of complaints |  _pandas, matplotlib_ |   
